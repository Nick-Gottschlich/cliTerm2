...
- This project would not exist if not for the excellent [https://github.com/LazoCoder/Pokemon-Terminal](Pokemon-Terminal) project by LazoCoder. I forked their work as an way to begin making what I wanted to create, and would be totally lost without it.
